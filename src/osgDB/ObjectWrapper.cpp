...
ObjectWrapperManager::ObjectWrapperManager()
{
    ...
    primitiveTable.add( "GL_LINES_ADJACENCY_EXT", GL_LINES_ADJACENCY );
    primitiveTable.add( "GL_LINE_STRIP_ADJACENCY_EXT", GL_LINE_STRIP_ADJACENCY );
    primitiveTable.add( "GL_TRIANGLES_ADJACENCY_EXT", GL_TRIANGLES_ADJACENCY );
    primitiveTable.add( "GL_TRIANGLE_STRIP_ADJACENCY_EXT", GL_TRIANGLE_STRIP_ADJACENCY );
